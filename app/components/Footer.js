...
export default function SimpleFooter() {
  return (
    <footer className="dark:text-white mt-20 px-10 flex w-full flex-row flex-wrap items-center justify-center gap-y-6 gap-x-12 border-t border-blue-gray-50 py-6 text-center md:justify-between">
